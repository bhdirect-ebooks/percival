...
const getRefs = (block_id, orig_html) => {
  ...
  $('a')
    ...
    .each((i, elem) => {
      ...
      data.confirmed = /epub:type="footnote"/.test(orig_html) ? false : data.confirmed
...
const prepReportData = (vol_title, all_data, opts) => {
  ...
  chunks.forEach(chunk => {
    ...
    doc_blocks.forEach(b => {
      blocks[b.block_id] = {
        html: b.html,
        refs: b.refs, // MAYBE remove b.confidence before this if b.html shows this is a footnote block
      }
    })
