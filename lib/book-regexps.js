...
const books = [
  ...
  {
    osis: ['Song'],
    regexp: /\b(?:S(?:S|gs?| of S|ngs?|o(?:[Sl]|n(?:g(?: of S(?:o(?:ngs?|lom[oa]ns?)|alom[oa]ns?)|s(?: of S(?:o(?:ngs?|lom[oa]ns?)|alom[oa]ns?))?)?)?)?)|The Song(?: of S(?:o(?:ngs?|lom[oa]ns?)|alom[oa]ns?)|s of S(?:o(?:ngs?|lom[oa]ns?)|alom[oa]ns?)))\b(?! of (?:man|God))/
  },
  {
    osis: ['Isa'],
